...
pub struct WasmWhichDateGame {
    ...
    game_variant_input_year: HtmlInputElement,
    game_variant_input_decade: HtmlInputElement,
...
impl WasmWhichDateGame {
    ...
    pub fn new() -> Self {
        ...
        let game = Self {
            ...
            game_variant_input_year: get_element!(document, "input[year]", HtmlInputElement),
            game_variant_input_decade: get_element!(document, "input[decade]", HtmlInputElement),
    ...
    pub fn new_game(&mut self) -> Result<(), GameError> {
        ...
        self.game_variant_input_year.set_disabled(true);
        self.game_variant_input_decade.set_disabled(true);
    ...
    pub fn end_game(&self) {
        ...
        self.game_variant_input_year.set_disabled(false);
        self.game_variant_input_decade.set_disabled(false);
